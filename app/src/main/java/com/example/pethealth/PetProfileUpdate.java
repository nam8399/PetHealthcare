...
public class PetProfileUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_profile_update);
        ...
        et_radiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if(i == R.id.et_gender) {
                    Toast.makeText(PetProfileUpdate.this,"수컷입니다", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful())
                    {
                        Toast.makeText(PetProfileUpdate.this, "업로드 성공", Toast.LENGTH_SHORT).show();
...
*/
        ...
        {
            Toast.makeText(PetProfileUpdate.this, "이미지 선택 안함", Toast.LENGTH_SHORT).show();
        }
    }
}
